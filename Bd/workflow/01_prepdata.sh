...
module load gmap
gmap_build -D $WORKDIR/genome -d ${BASE}_JEL423 ../../Bd/genome/batrachochytrium_dendrobatidis_1_supercontigs.fasta ../../Bd/genome/batrachochytrium_dendrobatidis_jel423_mitochondrial_assembly_1_1_supercontigs.fasta
