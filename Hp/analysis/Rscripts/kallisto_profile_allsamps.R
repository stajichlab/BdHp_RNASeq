...
write.csv(txi.kallisto$abundance,"reports/kallisto_allsamps.TPM.csv")
write.csv(txi.kallisto$counts,"reports/kallisto_allsamps.counts.csv")
...
pdf("plots/RNASeq_kallisto_allsamps.pdf")
